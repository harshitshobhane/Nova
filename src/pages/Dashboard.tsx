...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8">
      <div className="mb-2">
        <h1 className={`text-xl lg:text-2xl font-semibold ${headingText} mb-1`}>Welcome back, <span className="text-[#7c3aed]">Amit</span></h1>
        <p className={`text-sm lg:text-base ${subText}`}>Your AI-powered payment dashboard</p>
      </div>
